export const aboutData = {
    ...
    body: [
        { text: "Nées des textes de " },
        { text: "Mickaël Crépin", mark: true },
        { text: " et de son recueil " },
        { text: "De Boue et de Vent", mark: true },
        { text: ", les créations mêlent voix, musique et mise en espace pour faire de la poésie contemporaine une " },
        { text: "expérience immersive et incarnée", mark: true },
        { text: "." },
    ],
